...
class Flight(db.Model):
    ...
    airport = db.relationship('Airport', back_populates='flights')
    destination = db.relationship('Location', back_populates='flights')
    ...
    def bar(self):
        ...
        return f"from Flight class: {self}. Also this airport: {airport}"
